        ...
        async (uri?: vscode.Uri) => {
            ...
            try {
                ...
                const debugInfo = [
                    ...
                    `• Custom Colors: ${Object.keys(configInfo.customColors).length > 0
                        ? "Configured"
                        : "None"
                    }`,
                ...
                vscode.window.showErrorMessage(
                    `Debug info error: ${error instanceof Error ? error.message : "Unknown error"
                    }`
                );
            }
